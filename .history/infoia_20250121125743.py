...
def analyze_banana_labels(event=None, context=None):
    ...
    try:
        ...
        # Modificar el formato de fecha para BigQuery
        ...
        query = f"""
            ...
            WHERE DATE(TIMESTAMP(Fecha)) >= DATE('{formatted_date}')
        """
        
        print(f"Ejecutando consulta para registros desde: {formatted_date}")
        query_job = bq_client.query(query)
        rows = list(query_job.result())  # Convertir a lista para verificar si hay resultados
