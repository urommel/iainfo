...
def analyze_banana_labels(event=None, context=None):
    try:
        ...
        for row in rows:
            ...
            La escritura tiene que estar bien redactada, con coherencia y cohesión. Se debe utilizar un lenguaje técnico y profesional. NO SE COLOCA #, ##, ### o cualquier otro tipo de formato. SOLO POR ESPACIADO 
