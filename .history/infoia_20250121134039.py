...
def analyze_banana_labels(event=None, context=None):
    try:
        ...
        for row in rows:
            ...
            La escritura tiene que estar bien redactada, no incluyas símbolos de * o # en los titulos o cosas ## o ###, solo que sea texto escrito, si es por puntos normal se detalla.
